...
async def information_menu():
	markup = InlineKeyboardMarkup(
		inline_keyboard = [
			[
				InlineKeyboardButton(text = 'Channel', url='https://t.me/no_vandam'),
				InlineKeyboardButton(text = 'Chat', url='https://t.me/no_vandam'),
			],
			[
				InlineKeyboardButton(text = 'Checker', url='https://t.me/no_vandam'),
				InlineKeyboardButton(text = 'Admin', url='https://t.me/no_vandam'),
			],
			[
				InlineKeyboardButton(text = '🔙', callback_data='back'),
			],
